...
public class JPEGTool {
	...
	String [] SupportedFormat={".png",".jpg",".bmp",".gif",".tiff",".tif",".raw",".pnm",".pdf",".html",".ico"};
	ImageTool IT = new ImageTool(); 
	
	public void JpegConverter(String Path,String Target,String Extension){
		
		if(Extension.equalsIgnoreCase(".png")||Extension.equalsIgnoreCase(".bmp")||Extension.equalsIgnoreCase(".jpg")||Extension.equalsIgnoreCase(".gif")||Extension.equalsIgnoreCase(".pnm")||Extension.equalsIgnoreCase(".tif")||Extension.equalsIgnoreCase(".tiff")||Extension.equalsIgnoreCase(".raw")){

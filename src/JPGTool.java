...
public class JPGTool {


	String [] SupportedFormat={".png",".jpeg",".bmp",".gif",".tiff",".tif",".raw",".pnm",".pdf",".html",".ico"};
	ImageTool IT = new ImageTool(); 
	
	public void JpgConverter(String Path,String Target,String Extension){
		
		if(Extension.equalsIgnoreCase(".png")||Extension.equalsIgnoreCase(".bmp")||Extension.equalsIgnoreCase(".jpeg")||Extension.equalsIgnoreCase(".gif")||Extension.equalsIgnoreCase(".pnm")||Extension.equalsIgnoreCase(".tif")||Extension.equalsIgnoreCase(".tiff")||Extension.equalsIgnoreCase(".raw")){
